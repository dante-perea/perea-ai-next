...
length: "~5,400 words"
license: "CC BY 4.0"
description: "The second cross-vertical operator playbook in the State-of-Vertical-Agents canon (after vertical-corpus-moat-field-manual #23), derived from legal #16, insurance #17, founder-velocity #18, healthcare #19, accounting #20, CRE #21, and construction #22. Decodes the four-lever prestige-led distribution motion that produced Harvey's $11B valuation in March 2026 (100,000+ lawyers across 1,300 organizations after the A&O Shearman 4,000-staff rollout + DLA Piper 5,000-license March 2026 expansion), Hippocratic AI's $3.5B Series C in November 2025 (50+ health systems including Cleveland Clinic + Northwestern + UHS + University Hospitals after the Mount Sinai inflection), Abridge's 200+ health-system trust with UPMC scaling to 12,000 clinicians by 2026 across 40 hospitals + 800 outpatient sites at ~$2,500/clinician/year + Kaiser Permanente 40-hospital rollout, EvenUp's $2B valuation in October 2025 (1,500+ PI firms generating $7B+ in claims), and Tractable's $1B unicorn anchor (600% revenue growth in 24 months). The four levers: (1) anchor customer with quantified deployment story (4,000 lawyers / 12,000 clinicians / 50 health systems as the reference template), (2) demos run on the prospect's own public work product (EDGAR for legal, public claims data for insurance, public clinical-trial data for healthcare, public filings for accounting), (3) engineered referral graph (PE-fund + portfolio-company in legal; payor + health-system + pharma + Big-4-consulting in healthcare; carrier + TPA + reinsurer + state-regulator-sandbox in insurance), (4) expand-and-collapse UI (specialized agents collapsed into unified router with +47% activation). Maps vertical translation across all 6 verticals + when this playbook breaks (sub-vertical specialists who cannot land an anchor customer in the first 6 months) + pricing implications anchored to incumbent reference cost."
---
...
- **Healthcare scribes — Abridge**: UPMC enterprise-wide / 12,000 clinicians by 2026 / 40 hospitals / 800 outpatient sites / ~$2,500/clinician/year (~$30M ARR from UPMC alone) / 44 specialties live including oncology, OB/GYN, cardiology, neurology.
- **Healthcare nurse co-pilot — Hippocratic AI**: Mount Sinai + Cleveland Clinic + Northwestern Medicine + University Hospitals + UHS Universal Health Services / 50+ health systems + payors + pharma in 6 countries / 1,000+ clinical use cases / 115M+ patient interactions / zero safety incidents.
...
- **Harvey at $1,000-$1,200/seat/month enterprise** (~$12-14K/lawyer/year) — anchored to BigLaw associate-billable-cost reference (~$200/hour × 50 hours displaced = $10K/year recoverable productivity, with the 1.4-1.6x productivity ceiling validated cross-vertically).
- **Legora at $3,000/user/year + $30K ACV floor** — anchored to European-jurisdiction-licensed-attorney cost reference + EU-AI-Act-compliance-positioning premium.
