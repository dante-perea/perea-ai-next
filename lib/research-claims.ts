...
const PRIMARY_PATTERNS: RegExp[] = [
  ...
  // W3C Community Group documents and reference-implementation canonical docs
  /(^|\.)webmachinelearning\.github\.io(\/|$)/i,
  /(^|\.)docs\.mcp-b\.ai(\/|$)/i,
  ...
  /(^|\.)sierra\.ai(\/|$)/i,
  /(^|\.)decagon\.ai(\/|$)/i,
  /(^|\.)webflow2\.decagon\.ai(\/|$)/i,
  /(^|\.)docs\.snowflake\.com(\/|$)/i,
  /(^|\.)mlflow\.org(\/|$)/i,
  /(^|\.)11x\.ai(\/|$)/i,
  /(^|\.)artisan\.co(\/|$)/i,
  /(^|\.)bardeen\.ai(\/|$)/i,
...
const BROWSER_AGENT_PERCEPTION_PRIMARY_PATTERNS: RegExp[] = [
  ...
  /(^|\.)aiaaic\.org(\/|$)/i,
  /(^|\.)www\.aiaaic\.org(\/|$)/i,
  /(^|\.)incidentdatabase\.ai(\/|$)/i,
  /(^|\.)ojs\.aaai\.org(\/|$)/i,
  /(^|\.)aaai\.org(\/|$)/i,
  /(^|\.)research\.buaa\.edu\.cn(\/|$)/i,
  /\.edu\.cn(\/|$)/i,
  ...
  /(^|\.)www\.cursor\.com(\/|$)/i,
  /(^|\.)e2b\.dev(\/|$)/i,
  /(^|\.)blog\.firetiger\.com(\/|$)/i,
  /(^|\.)firetiger\.com(\/|$)/i,
  /(^|\.)blog\.railway\.com(\/|$)/i,
  /(^|\.)railway\.com(\/|$)/i,
  /(^|\.)policylayer\.com(\/|$)/i,
  /(^|\.)www\.policylayer\.com(\/|$)/i,
  /(^|\.)killswitch\.md(\/|$)/i,
  /(^|\.)meshai\.dev(\/|$)/i,
  /(^|\.)docs\.meshai\.dev(\/|$)/i,
  /(^|\.)cordum\.io(\/|$)/i,
...
const BROWSER_VS_PROTOCOL_SECONDARY_PATTERNS: RegExp[] = [
  ...
  /(^|\.)www\.bbc\.com(\/|$)/i,
  /(^|\.)computing\.co\.uk(\/|$)/i,
  /(^|\.)www\.computing\.co\.uk(\/|$)/i,
  /(^|\.)thehill\.com(\/|$)/i,
  /(^|\.)digital-release\.thehill\.com(\/|$)/i,
  /(^|\.)theprovince\.com(\/|$)/i,
  /(^|\.)simonwillison\.net(\/|$)/i,
  /(^|\.)xor\.tech(\/|$)/i,
  /(^|\.)www\.xor\.tech(\/|$)/i,
  ...
  /(^|\.)www\.o137\.ai(\/|$)/i,
  /(^|\.)ai-agentsplus\.com(\/|$)/i,
  /(^|\.)www\.ai-agentsplus\.com(\/|$)/i,
  /(^|\.)agenticcareers\.co(\/|$)/i,
  /(^|\.)claudelab\.net(\/|$)/i,
  /(^|\.)appropri8-astro\.pages\.dev(\/|$)/i,
  /(^|\.)antigravitylab\.net(\/|$)/i,
  /(^|\.)agentic-patterns\.com(\/|$)/i,
  /(^|\.)prophetfrom\.ai(\/|$)/i,
  /(^|\.)claudecodeguides\.com(\/|$)/i,
...
const SECONDARY_PATTERNS: RegExp[] = [
  ...
  /(^|\.)winbuzzer\.com(\/|$)/i,
  /(^|\.)pub\.towardsai\.net(\/|$)/i,
  // Conversion / AI-traffic benchmark studies with quantitative datasets
  /(^|\.)thedigitalbloom\.com(\/|$)/i,
  /(^|\.)webfx\.com(\/|$)/i,
  /(^|\.)visibilitylabs\.ai(\/|$)/i,
  /(^|\.)searchless\.ai(\/|$)/i,
  /(^|\.)loamly\.ai(\/|$)/i,
  ...
  /(^|\.)wearepresta\.com(\/|$)/i,
  /(^|\.)folio3\.com(\/|$)/i,
  /(^|\.)ecommerce\.folio3\.com(\/|$)/i,
  // Named-author technical analyst blogs (with editorial standards)
  /(^|\.)ivanturkovic\.com(\/|$)/i,
  /(^|\.)weeraman\.com(\/|$)/i,
  /(^|\.)gerl\.dev(\/|$)/i,
  /(^|\.)tessl\.io(\/|$)/i,
